...
const CreateProject = ({ addProject, skills }) => {
                    ...
                    <div className="card__content profile-content">
                            ...
                            <div className="profile__info">
                                <div className="settings-field">
                                    <div className="settings__item">
                                        <label className="text-label" for="title">Title</label>
                                        <input className="text-input" id="title" type="text" placeholder="Title" value={title} ref={titleInput} onChange={() => onChangeHandler('title')} />
                                    </div>

                                    <div className="settings__item">
                                        <label className="text-label" for="status">Status</label>
                                        <select className="text-input" id="status" type="text" placeholder="Status" value={status} ref={statusInput} onChange={() => onChangeHandler('status')}>
                                    ...
                                    <div className="settings__item">
                                        <label className="text-label" for="devs">Devs</label>
                                        <div className="input__item">
                                            <input className="text-input input_complex" disabled id="devs" type="text" placeholder="Devs" value={devs.join(', ')} ref={devsInput} onChange={() => onChangeHandler('devs')} />
                                            <button className="btn input_btn" onClick={() => ('')}>Add</button>
                                        </div>
                                    </div>

                                    <div className="settings__item">
                                        <label className="text-label" for="role">Need roles</label>
                                        <div className="input__item">
                                            <input className="text-input input_complex" disabled id="role" type="text" placeholder="Roles" value={roles.join(', ')} ref={rolesInput} onChange={() => onChangeHandler('roles')} />
                                            <button className="btn input_btn" onClick={() => ('')}>Add</button>
                                        </div>
                                    </div>

                                    <div className="settings__item">
                                        <label className="text-label" for="skills">Technical stack</label>
                                        <div className="input__item">
                                            <input className="text-input input_complex" disabled id="skills" type="text" placeholder="Tech stack" value={skillsStack.join(', ')} ref={skillsInput} onChange={() => onChangeHandler('skillsStack')} />
                        ...
                        <div className="profile-content_body">
                            <div className="profile__description">
                                ...
                                <textarea className="textarea-input" type="text" placeholder="Description" value={description} ref={descriptionInput} onChange={() => onChangeHandler('description')} />
                            </div>
                        </div>
