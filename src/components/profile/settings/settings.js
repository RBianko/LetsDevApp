                        ...
                        <div className="profile-content_header">
                            ...
                            <div className="profile__info">
                                <div className="settings-field">
                                    <input className="text-input" type="text" placeholder="First Name" value={firstName} ref={firstNameInput} onChange={() => onChangeHandler('firstName')} />
                                    <input className="text-input" type="text" placeholder="Last Name" value={lastName} ref={lastNameInput} onChange={() => onChangeHandler('lastName')} />
                                    <input className="text-input" type="text" placeholder="City" value={city} ref={cityInput} onChange={() => onChangeHandler('city')} />
                                    <select className="text-input" name="country" value={country} ref={countryInput} onChange={() => onChangeHandler('country')} >
